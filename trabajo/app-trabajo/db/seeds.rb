...
Exam.create("course_id"=>4, "title"=>"Test 1", "passing_score"=>60, "date"=>'2017-10-25')
...
Student.create("course_id"=>3, "surname"=>"Levine", "name"=>"Adam", "number"=>158790, "dni"=>395865, "email"=>"adaml@gmail.com")
