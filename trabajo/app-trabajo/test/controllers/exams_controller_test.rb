...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { date: @exam.date, passing_score: @exam.passing_score, title: @exam.title } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { date: @exam.date, passing_score: @exam.passing_score, title: @exam.title } }
